...
from ERACHAT.database.chats import add_served_chat
from ERACHAT.database.users import add_served_user
from config import MONGO_URL
from ERACHAT import ERACHAT, mongo, db
from pyrogram.types import Message
from ERACHAT.modules.helpers import CHATBOT_ON
from pymongo import MongoClient
from ERACHAT import mongo
from pyrogram.enums import ChatMemberStatus as CMS
from pyrogram.types import CallbackQuery, InlineKeyboardMarkup
import asyncio
import config
from ERACHAT import LOGGER, ERACHAT
...
@ERACHAT.on_message(filters.command("status"))
...
@ERACHAT.on_message(filters.command(["lang", "language", "setlang"]))
...
@ERACHAT.on_callback_query(filters.regex(r"setlang_"))
...
@ERACHAT.on_message(filters.command(["resetlang", "nolang"]))
...
@ERACHAT.on_message(filters.command("chatbot"))
...
@ERACHAT.on_message(filters.incoming)
async def chatbot_response(client: Client, message: Message):
    try:
        ...
        if (message.reply_to_message and message.reply_to_message.from_user.id == ERACHAT.id) or not message.reply_to_message:
